            ...
            <div className="sign-in-from">
              ...
              <form className="mt-4">
                ...
                <div className="d-flex justify-content-between my-2">
                  ...
                  <a href="/recover-password" className="float-end">Forgot password?</a>
                </div>
                ...
                <div className="sign-info">
                  <span className="dark-color d-inline-block line-height-2">Don't have an account? <a href="/sign-up">Sign up</a></span>
